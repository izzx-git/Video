...
namespace GMV_Join
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Укажите аргументы: Файлы картинки, Файл звука, Задержка в кадрах, Тип видео, Размер кадра звука");
            ...
            int sound_frame = Convert.ToInt16(args[4]); ; //размер кадра аудио
            ...
            {//GMV
                // sound_frame = 1614 * 1; //для 22050 моно 10 кадр/с
